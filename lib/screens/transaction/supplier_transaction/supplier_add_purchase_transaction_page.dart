...
class SupplierPurchaseTransactionAddPage extends StatefulWidget {
  const SupplierPurchaseTransactionAddPage({Key? key}) : super(key: key);

  @override
  State<SupplierPurchaseTransactionAddPage> createState() => _SupplierPurchaseTransactionAddPageState();
}
